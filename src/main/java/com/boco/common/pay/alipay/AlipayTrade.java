...
public class AlipayTrade {
    ...
    public String TradeWapPayRequest(Map<String, String> sParaTemp){
        ...
        alipayRequest.setBizContent(JsonUtils.getJsonFormat(sParaTemp));
        String form = "";
        try {
    ...
    public boolean tradeRefundRequest(Map<String, ?> sParaTemp) throws AlipayApiException {
        ...
        // 待请求参数数组
        request.setBizContent(JsonUtils.getJsonFormat(sParaTemp));
    ...
    public boolean verifyNotify(HttpServletRequest request) throws AlipayApiException {
        ...
        if (AlipayConfig.SUCCESS_REQUEST.equals(paranMap.get("trade_status")) || AlipayConfig.TRADE_FINISHED.equals(paranMap.get("trade_status"))) {
