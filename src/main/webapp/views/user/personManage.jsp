	...
	<div class="message-box">
		<div class="left-msg">
		        <ul>
		            ...
		            <li>
		                <a href="/BRHP/user/userPatients" class="current">
		                    <img src="/BRHP/statics/image/bbb/Patient1.png" alt=""/>
		                    <span>就诊人管理</span>
		                </a>
		            </li>
		            <li>
		...
		<div class="right_msg">
			...
			<div class="h">
			 ...
			 <div class="msg_p2 clearfix">
	        	<div class="h ">
	        		<a href="javascript:void(0)" class="add_linkperson" id="addButton">
	        			新增联系人 <span>+</span>
	        		</a>
	        	</div>
	        	
	        	<div class="c mt10 table">
			...
			<!-- <div class="right-top">
				...
				<div class="h ">
		        		<a  class="add_linkperson"  id="addButton">
		        			新增联系人 <span>+</span>
		        		</a>
		        	</div>
...
<%@ include file="../include/footer.jsp"%>
			...
			$('#dataTable').bootstrapTable({
				...
				columns : [{
					...
					formatter : function(value,row,index) {
						return '<a onclick="delperson(\''+ row.id + '\')" class="blue_color">删除</a>&nbsp;&nbsp;<a class="blue_color" onclick="def(\''+ row.id + '\')">设为默认</a>'
					}
	...
	function delperson(id){
		...
		function def(id){
			if (id==null||id=="") {
				layer.msg('请选择要设置的人员信息！');
				return;
			}
			layer.msg('确认设置为默认就诊人？', {
				time : 0,
				btn : [ '是', '否' ],
				yes : function(index) {
					$.ajax({
						type : 'POST',
						url : '/BRHP/user/patientDef',
						data : {
							id :id
